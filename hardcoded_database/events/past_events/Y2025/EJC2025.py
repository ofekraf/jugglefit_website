        ...
        RouteResult(
            route=Route(
                ...
                tricks=[
                    ...
                    Trick(name="7c triples -> 7c quads", props_count=7, siteswap_x="7c 7{3} -> 7c 7{4}"),
                ]
            ),
            competitors={
        ...
        RouteResult(
            route=Route(
                ...
                tricks=[
                    ...
                    Trick(name="6 rounds 534 flatfronts", props_count=4, siteswap_x="6 rounds 5{F}3{F}4{F}"),
                    Trick(name="6c (4x,4x) alternating backross", props_count=4, comment="scissors", siteswap_x="6c (4x,4x{B})"),
