        ...
        RouteResult(
            route=Route(
                ...
                tricks=[
                    ...
                    Trick(name="5c cascade -> 1 round 7733, backrosses 3's -> cascade", props_count=5, siteswap_x="5c 5 -> 1 round 773{B}3{B} -> 5"),
        ...
        RouteResult(
            route=Route(
                ...
                tricks=[
                    ...
                    Trick(name="any -> 2c lazies -> 2c 53 backrosses -> any", props_count=4, siteswap_x="any -> 2c 4{/L} -> 2c 5{B}3{B} -> any"),
                    ...
                    Trick(name="singles -> triples -> singles", props_count=5, siteswap_x="5{1} -> 5{3} -> 5{1}"),
