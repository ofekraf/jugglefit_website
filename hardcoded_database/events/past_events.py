        ...
        results=[
            RouteResult(
                route=Route(
                    ...
                    tricks=[
                        ...
                        Trick(name="6c async any -> 4c 9555, backcrosses 5's -> async any", props_count=6),
            ...
            RouteResult(
                route=Route(
                    ...
                    duration_seconds=600,
                    tricks=[
                        Trick(name="3c backcrosses singles -> flatfronts flats", props_count=3),
            ...
            RouteResult(
                route=Route(
                    ...
                    tricks=[
                        ...
                        Trick(name="5c cascade -> 4c 7733, backcrosses 3's -> cascade", props_count=5),
            ...
            RouteResult(
                route=Route(
                    ...
                    tricks=[
                        ...
                        Trick(name="6c (4x,4x) alternating backcross", props_count=4, comment="scissors"),
            ...
            RouteResult(
                route=Route(
                    ...
                    tricks=[
                        ...
                        Trick(name="3c cascade -> 3c reverse shoulders -> 3c backcrosses -> 3c overheads", props_count=3),
